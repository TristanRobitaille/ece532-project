...
#include "text_overlay_bin/overlay_text_bin.h"
//#include "xuartps.h"
#include "math.h"
#include <ctype.h>
#include <stdlib.h>
...
void DemoRun()
{
	...
	int freq = 880;
	int past_freq = 880;
	u32* frequency = (u32*) XPAR_FREQUENCY_INPUT_0_S00_AXI_BASEADDR;
	xil_printf("before while \n\r");
	while(1) {
		if(freq !=0 && freq > 256 && freq < 1000 && freq != 255) past_freq = freq;
		freq = *frequency;
		if(abs(freq - past_freq) > 10 && freq > 256 && freq < 1000 && freq != 255) analyseNote(freq);
