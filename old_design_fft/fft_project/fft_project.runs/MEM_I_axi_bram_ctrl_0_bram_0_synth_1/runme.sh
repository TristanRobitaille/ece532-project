...
HD_PWD='C:/ECE532/fft_project/fft_project/fft_project.runs/MEM_I_axi_bram_ctrl_0_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MEM_I_axi_bram_ctrl_0_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MEM_I_axi_bram_ctrl_0_bram_0.tcl
