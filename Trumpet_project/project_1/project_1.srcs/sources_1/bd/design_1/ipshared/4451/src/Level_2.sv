module level_2(
    ...
    radix_4_butterfly B_2(
        ...
        .B_img_I(in_i_6[15:0]),
        .A_real_II(in_5[15:0]),
        .A_img_II(in_i_5[15:0]),
        .B_real_II(in_7[15:0]),
        .B_img_II(in_i_7[15:0]),
        .tf_0_r(twd_0_r),
        .tf_0_i(twd_0_i),
        .tf_8_r(twd_8_r),
        .tf_8_i(twd_8_i),
    ...
    radix_4_butterfly B_3(
        ...
        .A_img_I(in_i_8[15:0]),
        .B_real_I(in_10[15:0]),
        .B_img_I(in_i_10[15:0]),
        .A_real_II(in_9[15:0]),
        .A_img_II(in_i_9[15:0]),
        .B_real_II(in_11[15:0]),
        .B_img_II(in_i_11[15:0]),
        .tf_0_r(twd_0_r),
        .tf_0_i(twd_0_i),
        .tf_8_r(twd_8_r),
        .tf_8_i(twd_8_i),
    ...
    radix_4_butterfly B_4 (
        ...
        .rstn(rstn),
        .A_real_I(in_12[15:0]),
        .A_img_I(in_i_12[15:0]),
        .B_real_I(in_14[15:0]),
        .B_img_I(in_i_14[15:0]),
        .A_real_II(in_13[15:0]),
        .A_img_II(in_i_13[15:0]),
        .B_real_II(in_15[15:0]),
        .B_img_II(in_i_15[15:0]),
        .tf_0_r(twd_0_r),
        .tf_0_i(twd_0_i),
        .tf_8_r(twd_8_r),
        .tf_8_i(twd_8_i),
    ...
    radix_4_butterfly B_5 (
        ...
        .B_real_I(in_18[15:0]),
        .B_img_I(in_i_18[15:0]),
        .A_real_II(in_17[15:0]),
        .A_img_II(in_i_17[15:0]),
        .B_real_II(in_19[15:0]),
        .B_img_II(in_i_19[15:0]),
        .tf_0_r(twd_0_r),
        .tf_0_i(twd_0_i),
        .tf_8_r(twd_8_r),
        .tf_8_i(twd_8_i),
    ...
    radix_4_butterfly B_6 (
        ...
        .rstn(rstn),
        .A_real_I(in_20[15:0]),
        .A_img_I(in_i_20[15:0]),
        .B_real_I(in_22[15:0]),
        .B_img_I(in_i_22[15:0]),
        .A_real_II(in_21[15:0]),
        .A_img_II(in_i_21[15:0]),
        .B_real_II(in_23[15:0]),
        .B_img_II(in_i_23[15:0]),
        .tf_0_r(twd_0_r),
        .tf_0_i(twd_0_i),
        .tf_8_r(twd_8_r),
        .tf_8_i(twd_8_i),
    ...
    radix_4_butterfly B_7 (
        ...
        .B_real_I(in_26[15:0]),
        .B_img_I(in_i_26[15:0]),
        .A_real_II(in_25[15:0]),
        .A_img_II(in_i_25[15:0]),
        .B_real_II(in_27[15:0]),
        .B_img_II(in_i_27[15:0]),
        .tf_0_r(twd_0_r),
        .tf_0_i(twd_0_i),
        .tf_8_r(twd_8_r),
        .tf_8_i(twd_8_i),
    ...
    radix_4_butterfly B_8 (
        ...
        .rstn(rstn),
        .A_real_I(in_28[15:0]),
        .A_img_I(in_i_28[15:0]),
        .B_real_I(in_30[15:0]),
        .B_img_I(in_i_30[15:0]),
        .A_real_II(in_29[15:0]),
        .A_img_II(in_i_29[15:0]),
        .B_real_II(in_31[15:0]),
        .B_img_II(in_i_31[15:0]),
        .tf_0_r(twd_0_r),
        .tf_0_i(twd_0_i),
        .tf_8_r(twd_8_r),
        .tf_8_i(twd_8_i),
