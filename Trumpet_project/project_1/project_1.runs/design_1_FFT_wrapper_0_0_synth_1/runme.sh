...
HD_PWD='C:/ECE532/GITHUB_PRO/ECE532-project/Trumpet_project/project_1/project_1.runs/design_1_FFT_wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_FFT_wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_FFT_wrapper_0_0.tcl
