...
HD_PWD='C:/ECE532/git-version/ECE532-project/Trumpet_project/project_1/project_1.runs/design_1_fft_wrapper_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fft_wrapper_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fft_wrapper_0_1.tcl
