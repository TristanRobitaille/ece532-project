...
HD_PWD='C:/Users/robita46/ECE532-project-main/ECE532-project-main/Trumpet_project/project_1/project_1.runs/design_1_axi_dma_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_dma_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_dma_1.tcl
