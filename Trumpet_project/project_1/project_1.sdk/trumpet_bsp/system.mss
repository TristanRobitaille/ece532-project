...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = i2c_cap_btn_axi_cap_btn_gpio
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.5
 PARAMETER HW_INSTANCE = i2c_cap_btn_axi_iic_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = AXI_I2S_driver
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = I2S_audio_AXI_I2S_driver_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.5
 PARAMETER HW_INSTANCE = I2S_audio_axi_iic_1
END
