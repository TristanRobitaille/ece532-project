...
HD_PWD='C:/ECE532/fft_project/fft_ip_II/fft_project/fft_project.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log FFT_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FFT_wrapper.tcl -notrace
