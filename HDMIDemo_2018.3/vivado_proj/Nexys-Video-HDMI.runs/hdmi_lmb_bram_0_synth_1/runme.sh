...
HD_PWD='C:/Users/ECE53/Desktop/final_demo/ECE532-project/HDMIDemo_2018.3/vivado_proj/Nexys-Video-HDMI.runs/hdmi_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_lmb_bram_0.tcl
