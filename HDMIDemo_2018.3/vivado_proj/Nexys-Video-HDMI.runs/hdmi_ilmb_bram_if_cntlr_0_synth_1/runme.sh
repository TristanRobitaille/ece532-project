...
HD_PWD='C:/Users/jason/ECE532/ECE532-project/HDMIDemo_2018.3/vivado_proj/Nexys-Video-HDMI.runs/hdmi_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_ilmb_bram_if_cntlr_0.tcl
