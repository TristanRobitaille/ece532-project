...
HD_PWD='C:/Users/ECE53/Desktop/final_demo/ECE532-project/HDMIDemo_2018.3/vivado_proj/Nexys-Video-HDMI.runs/hdmi_axi_gpio_video_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_axi_gpio_video_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_axi_gpio_video_0.tcl
