...
HD_PWD='C:/Users/ECE53/Desktop/mid-project_demo/ECE532-project/microphone/spi_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_wrapper.tcl
