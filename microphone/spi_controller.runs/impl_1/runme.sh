...
HD_PWD='C:/Users/ECE53/Desktop/mid-project_demo/ECE532-project/microphone/spi_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_wrapper.tcl -notrace
