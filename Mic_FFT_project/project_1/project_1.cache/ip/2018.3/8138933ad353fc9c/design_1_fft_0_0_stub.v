...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk_100MHz, rstn, input_data, valid, fft_done, 
  fft_pwm, frequency)
/* synthesis syn_black_box black_box_pad_pin="clk_100MHz,rstn,input_data[11:0],valid,fft_done,fft_pwm,frequency[31:0]" */;
  input clk_100MHz;
  input rstn;
