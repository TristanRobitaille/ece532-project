...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_I2S_driver_v1_0_S00_AXI is
  ...
  signal current_data : STD_LOGIC_VECTOR ( 23 downto 8 );
  signal \current_data[23]_i_1_n_0\ : STD_LOGIC;
  signal \current_data[23]_i_2_n_0\ : STD_LOGIC;
  signal \intra_word_cnt[0]_i_1_n_0\ : STD_LOGIC;
  signal \intra_word_cnt[2]_i_1_n_0\ : STD_LOGIC;
  signal \intra_word_cnt[4]_i_1_n_0\ : STD_LOGIC;
  signal \intra_word_cnt[4]_i_3_n_0\ : STD_LOGIC;
  signal \intra_word_cnt_reg__0\ : STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  attribute SOFT_HLUTNM of bclk_i_1 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \current_data[23]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \intra_word_cnt[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \intra_word_cnt[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \intra_word_cnt[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \intra_word_cnt[4]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \intra_word_cnt[4]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of lrclk_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of mclk_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of sd_i_4 : label is "soft_lutpair4";
begin
  CLK <= \^clk\;
...
\current_data[23]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"04FF"
    )
        port map (
      I0 => \current_data[23]_i_2_n_0\,
      I1 => cnt(5),
      I2 => cnt(4),
      I3 => nrst,
      O => \current_data[23]_i_1_n_0\
    );
\current_data[23]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\intra_word_cnt[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \intra_word_cnt_reg__0\(0),
      O => \intra_word_cnt[0]_i_1_n_0\
    );
\intra_word_cnt[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => \intra_word_cnt_reg__0\(1),
      I1 => \intra_word_cnt_reg__0\(0),
      O => \p_0_in__0\(1)
    );
\intra_word_cnt[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
    )
        port map (
      I0 => \intra_word_cnt_reg__0\(2),
      I1 => \intra_word_cnt_reg__0\(0),
      I2 => \intra_word_cnt_reg__0\(1),
      O => \intra_word_cnt[2]_i_1_n_0\
    );
\intra_word_cnt[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6AAA"
    )
        port map (
      I0 => \intra_word_cnt_reg__0\(3),
      I1 => \intra_word_cnt_reg__0\(1),
      I2 => \intra_word_cnt_reg__0\(0),
      I3 => \intra_word_cnt_reg__0\(2),
      O => \p_0_in__0\(3)
    );
\intra_word_cnt[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"5555755D"
    )
        port map (
      ...
      I2 => cnt(5),
      I3 => cnt(3),
      I4 => \intra_word_cnt[4]_i_3_n_0\,
      O => \intra_word_cnt[4]_i_1_n_0\
    );
\intra_word_cnt[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6AAAAAAA"
    )
        port map (
      I0 => \intra_word_cnt_reg__0\(4),
      I1 => \intra_word_cnt_reg__0\(2),
      I2 => \intra_word_cnt_reg__0\(0),
      I3 => \intra_word_cnt_reg__0\(1),
      I4 => \intra_word_cnt_reg__0\(3),
      O => \p_0_in__0\(4)
    );
\intra_word_cnt[4]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\intra_word_cnt_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => \^clk\,
      CE => '1',
      D => \intra_word_cnt[0]_i_1_n_0\,
      Q => \intra_word_cnt_reg__0\(0),
      R => \intra_word_cnt[4]_i_1_n_0\
    );
...
\intra_word_cnt_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => \^clk\,
      CE => '1',
      D => \intra_word_cnt[2]_i_1_n_0\,
      Q => \intra_word_cnt_reg__0\(2),
      R => \intra_word_cnt[4]_i_1_n_0\
    );
...
\intra_word_cnt_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      ...
      CE => '1',
      D => \p_0_in__0\(4),
      Q => \intra_word_cnt_reg__0\(4),
      R => \intra_word_cnt[4]_i_1_n_0\
    );
lrclk_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
