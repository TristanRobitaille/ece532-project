...
proc create_root_design { parentCell } {
  ...
  set fft_freq_out [ create_bd_port -dir O -from 15 -to 0 fft_freq_out ]
  ...
  set vadj [ create_bd_port -dir O -from 2 -to 0 -type data vadj ]
  ...
  # Create instance: fft_AXI_V_0, and set properties
  set fft_AXI_V_0 [ create_bd_cell -type ip -vlnv utoronto.ca:user:fft_AXI_V:5.0 fft_AXI_V_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M07_AXI [get_bd_intf_pins axi_interconnect_0/M07_AXI] [get_bd_intf_pins fft_AXI_V_0/S00_AXI]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins fft_AXI_V_0/mic_data] [get_bd_pins i2s_0/mic_data] [get_bd_pins mic_storage_0/mic_data] [get_bd_pins one_register_0/in_input] [get_bd_pins spi_controller_0/mic_data_out]
  connect_bd_net -net btn_rst_1 [get_bd_ports btn_rst] [get_bd_pins fft_AXI_V_0/s00_axi_aresetn] [get_bd_pins i2s_0/btn_rst] [get_bd_pins mic_storage_0/rst_n] [get_bd_pins playback_ctrl_0/btn_rst] [get_bd_pins spi_controller_0/rst_n]
  ...
  connect_bd_net -net mic_storage_0_playback_data [get_bd_pins fft_AXI_V_0/playback_data] [get_bd_pins i2s_0/playback_data] [get_bd_pins mic_storage_0/playback_data]
  ...
  connect_bd_net -net playback_ctrl_0_speaker_mode [get_bd_ports led_playback_mode] [get_bd_pins fft_AXI_V_0/input_source] [get_bd_pins i2s_0/input_source] [get_bd_pins playback_ctrl_0/speaker_mode]
  ...
  connect_bd_net -net spi_controller_0_new_data_ready_clk_100MHz [get_bd_pins fft_AXI_V_0/valid] [get_bd_pins mic_storage_0/new_sample] [get_bd_pins spi_controller_0/new_data_ready_clk_100MHz]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_ports vadj] [get_bd_pins xlconstant_0/dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs fft_AXI_V_0/S00_AXI/S00_AXI_reg] SEG_fft_AXI_V_0_S00_AXI_reg
