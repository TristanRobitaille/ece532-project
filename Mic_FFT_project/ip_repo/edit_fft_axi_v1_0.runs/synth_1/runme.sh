...
HD_PWD='c:/users/robita46/ece532-project-fft/ece532-project-fft/trumpet_project/ip_repo/edit_fft_axi_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_axi_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_axi_v1_0.tcl
