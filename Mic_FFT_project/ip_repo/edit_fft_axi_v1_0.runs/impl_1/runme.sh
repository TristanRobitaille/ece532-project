...
HD_PWD='c:/users/robita46/ece532-project-fft/ece532-project-fft/trumpet_project/ip_repo/edit_fft_axi_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_axi_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_axi_v1_0.tcl -notrace
