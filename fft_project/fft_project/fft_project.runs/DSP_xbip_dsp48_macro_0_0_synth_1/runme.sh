...
HD_PWD='C:/ECE532/fft_project/fft_project/fft_project.runs/DSP_xbip_dsp48_macro_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP_xbip_dsp48_macro_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DSP_xbip_dsp48_macro_0_0.tcl
