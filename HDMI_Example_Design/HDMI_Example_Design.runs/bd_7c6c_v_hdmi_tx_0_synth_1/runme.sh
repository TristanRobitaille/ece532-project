...
HD_PWD='C:/Users/jason/ECE532/ECE532-project/HDMI_Example_Design/HDMI_Example_Design.runs/bd_7c6c_v_hdmi_tx_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_7c6c_v_hdmi_tx_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_7c6c_v_hdmi_tx_0.tcl
