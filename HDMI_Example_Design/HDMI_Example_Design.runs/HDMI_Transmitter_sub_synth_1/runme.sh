...
HD_PWD='C:/Users/jason/ECE532/ECE532-project/HDMI_Example_Design/HDMI_Example_Design.runs/HDMI_Transmitter_sub_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_Transmitter_sub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_Transmitter_sub.tcl
